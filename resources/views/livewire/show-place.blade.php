...
<div class="p-8">
    <div class="flex justify-between mx-4 my-2">
        <h3 class="object-left-top text-xl m-3 p-2 font-semibold">{{$placeTypek}} à {{ $place->commune->name }}</h3>
    ...
    <div>
        ...
        <div class="w-full h-fit  border-t-2 pt-2">
            <div class="flex justify-center">
                <div class="aspect-video flex justify-center h-96 max-h-96 bg-gray-300">
                    ...
                    @else
                        ...
                        @if ($videos[$videoSelectedIndex]) 
                            <div class="">
                                <video class="object-fill max-h-96" src="{{ $path.$videos[$videoSelectedIndex]->url }}">
                            </div>
                        @else
