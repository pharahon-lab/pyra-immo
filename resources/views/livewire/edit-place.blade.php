        ...
        <div class="flex justify-between gradient">
            ...
            <div class="flex justify-end px-8 py-4">
                ...
                <div class="flex-col">
                    ...
                    <div>
                        <select class="text-black shadow-md rounded-r-full" name="commune" id="commune" wire:model="placeForm.commune_id">
                ...
                <div class="flex justify-center my-4">
                    <div class="flex justify-center w-2/3 flex-col">
                        <div class="flex flex-col content-center m-2">
                            ...
                            <textarea class="w-full h-50" type="text" id="condition" name="condition" wire:model="placeForm.conditions"></textarea>
                        </div>
                    </div>                    
                </div>
